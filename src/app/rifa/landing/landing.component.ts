...
@Component({
  ...
  standalone: true,
  imports: [BannerPrincipalComponent, RifaPasosComponent, RifaComprimidaCarouselComponent, RifaComprimidaCarouselComponent, RifaCalendarioGanadoresComponent, RifaBannerProximoPremioComponent],
